      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Our Success Story:
            <span className="text-orange"> Elyscents</span>
          </h2>
        ...
        <div className="max-w-6xl mx-auto">
          <Card className="bg-gradient-to-br from-orange/20 to-orange/10 border-orange/30 text-white border overflow-hidden">
            <CardContent className="p-12">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  <h3 className="text-3xl font-bold mb-6 text-white">Elyscents: A Pakistani Success Story</h3>
                  ...
                  <div className="grid grid-cols-2 gap-6 mb-8">
                    ...
                    <div className="text-center">
                      <div className="text-4xl font-bold text-orange mb-2">1M+</div>
                      <div className="text-gray-400">Monthly Revenue</div>
                    </div>
                    <div className="text-center">
                      <div className="text-4xl font-bold text-orange mb-2">50k+</div>
                      <div className="text-gray-400">Happy Customers</div>
                    </div>
                    <div className="text-center">
                      <div className="text-4xl font-bold text-orange mb-2">2 Years</div>
                      <div className="text-gray-400">To Success</div>
                    </div>
                  </div>
                  
                  <blockquote className="text-lg italic text-gray-300 border-l-4 border-orange pl-6">
                ...
                <div className="relative">
                  <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8">
                    ...
                    />
                    <div className="text-center">
                      <h4 className="text-xl font-semibold mb-2 text-white">From Startup to Market Leader</h4>
